...
public class LRUCache {
	...
	the cache. If the number of keys exceeds the capacity from this operation, evict the least recently used key. The
	...
	// add from the left side, after dummy head node
